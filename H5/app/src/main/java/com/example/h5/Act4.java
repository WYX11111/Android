    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStartAty2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Act4.this, Ayt2.class);
                startActivity(i);
        ...
        btnStartAty3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Act4.this, Aty3.class);
                startActivity(i);
        ...
        btnStartAty4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Act4.this, Act4.class);
                startActivity(i);
        ...
        browser.loadUrl("http://www.classicpoetry.net/List.aspx?LMBH=f94232cd-9c56-4288-93d8-15435b25f385");
