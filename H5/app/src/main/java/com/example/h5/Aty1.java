    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStartAty1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Aty1.this, Aty1.class);
                startActivity(i);
        ...
        btnStartAty2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Aty1.this, Ayt2.class);
                startActivity(i);
        ...
        btnStartAty3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Aty1.this, Aty3.class);
                startActivity(i);
        ...
        btnStartAty4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Aty1.this, Act4.class);
                startActivity(i);
        ...
        browser.loadUrl("http://www.classicpoetry.net/PoemList.aspx");
